...
import { ArrowLeft, Timer, HeartPulse } from "lucide-react";
        ...
        <div className="max-w-2xl mx-auto text-center space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-muted-foreground">
              We're currently building our network of trusted healthcare
          ...
          <div className="bg-muted/50 rounded-lg p-6 space-y-4">
            ...
            <div className="space-y-2 text-sm">
              <p>Our healthcare service will include:</p>
              <ul className="space-y-1">
                <li>✓ Licensed medical professionals</li>
                <li>✓ Specialty-specific matching</li>
                <li>✓ Verified credentials</li>
                <li>✓ Detailed practitioner profiles</li>
              </ul>
            </div>
          </div>
