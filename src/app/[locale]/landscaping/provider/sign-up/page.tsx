          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground">
                Join our network of professional landscapers and get connected
            ...
            <ul className="space-y-4 text-muted-foreground">
              <li className="flex items-center gap-2">
                ...
                Access to pre-qualified landscaping leads
              </li>
              <li className="flex items-center gap-2">
                <div className="h-2 w-2 rounded-full bg-primary" />
            ...
            <div className="relative bg-background/80 backdrop-blur-xl rounded-lg border shadow-lg p-6">
              <div className="text-center mb-8">
                ...
                <p className="text-muted-foreground">
                  Register your landscaping business to start receiving quality
                  leads.
                </p>
              </div>
              <ProviderSignUpForm
